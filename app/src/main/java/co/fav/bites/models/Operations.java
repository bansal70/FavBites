...
public class Operations {
    ...
    public static String followersParams(String id, String user_id) {
        String params = Config.follower_url + "?id=" + id
                +"&user_id="+user_id;
    ...
    public static String followingParams(String id, String user_id) {
        String params = Config.following_url + "?id=" + id
                +"&user_id="+user_id;
