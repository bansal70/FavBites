        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (status.equals("1"))
                        EventBus.getDefault().postSticky(new Event(Constants.FORGOT_PASSWORD_SUCCESS, msg));
                    else
                        EventBus.getDefault().postSticky(new Event(Constants.FORGOT_PASSWORD_FAILED, msg));
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                EventBus.getDefault().postSticky(new Event(Constants.FORGOT_PASSWORD_FAILED, Constants.SERVER_ERROR));
            }
        });
    }
}
