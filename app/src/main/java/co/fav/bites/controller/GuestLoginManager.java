        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (status.equals("1"))
                        EventBus.getDefault().postSticky(new Event(Constants.GUEST_LOGIN_SUCCESS, msg));
                    else
                        EventBus.getDefault().postSticky(new Event(Constants.GUEST_LOGIN_FAILED, msg));
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                EventBus.getDefault().postSticky(new Event(Constants.GUEST_LOGIN_FAILED, Constants.SERVER_ERROR));
            }
        });
    }
}
